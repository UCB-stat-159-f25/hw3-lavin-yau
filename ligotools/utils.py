...
def plot_detector_results(det, strain_whitenbp, template_match, template_H1, pcolor, time, timemax, tevent, SNR, eventname, plottype, datafreq, template_fft, d_eff, freqs, data_psd, fs):
    # -- Plot the result
